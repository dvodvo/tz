class TimezonesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @timezone.save
        format.html { redirect_to timezone_url(@timezone), notice: "Timezone was successfully created." }
  ...
  def update
    respond_to do |format|
      if @timezone.update(timezone_params)
        format.html { redirect_to timezone_url(@timezone), notice: "Timezone was successfully updated." }
  ...
  private
    ...
    def timezone_params
      params.require(:timezone).permit(:utc_offset, :is_dst, :name)
    end
end
