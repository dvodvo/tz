...
class IndividualsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create individual" do
    assert_difference("Individual.count") do
      post individuals_url, params: { individual: { name: @individual.name, tz: @individual.tz } }
    end
  ...
  test "should update individual" do
    patch individual_url(@individual), params: { individual: { name: @individual.name, tz: @individual.tz } }
