...
class TimezonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timezone" do
    assert_difference("Timezone.count") do
      post timezones_url, params: { timezone: { is_dst: @timezone.is_dst, name: @timezone.name, utc_offset: @timezone.utc_offset } }
    end
  ...
  test "should update timezone" do
    patch timezone_url(@timezone), params: { timezone: { is_dst: @timezone.is_dst, name: @timezone.name, utc_offset: @timezone.utc_offset } }
